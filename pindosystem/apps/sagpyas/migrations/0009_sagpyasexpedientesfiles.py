# Generated by Django 4.2.5 on 2024-07-26 04:20
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('sagpyas', '0008_delete_sagpyasexpedientesfiles'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sagpyaexp', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sagpyasexp_files', to='sagpyas.sagpyasexpedientes')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='user_sagpyasexp_files', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
