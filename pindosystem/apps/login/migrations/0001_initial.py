    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('AG', 'General Administrator'), ('AA', 'Area Administrator'), ('AAWP', 'Area Administrator Witouth Permission'), ('DE', 'Data Entry')], default='DE', max_length=10, verbose_name='Role')),
